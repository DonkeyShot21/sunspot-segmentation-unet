...
class UNet(torch.nn.Module):
    ...
    def forward(self, x):
        ...
        self.x5 = self.relu(self.bn2(self.mid_conv2(self.x5)))
        self.x5 = self.relu(self.bn3(self.mid_conv3(self.x5)))

        #self.x6 = self.relu(self.bn1(self.mid_conv1(self.x5)))
        #self.x6 = self.relu(self.bn2(self.mid_conv2(self.x5)))
        #self.x6 = self.relu(self.bn3(self.mid_conv3(self.x5)))
        ...
        #x = self.up_block2(self.x5, self.x6)
        x = self.up_block3(self.x4, self.x5)
